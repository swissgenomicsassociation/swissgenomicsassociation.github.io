...
## Publications associées de partenaires externes

* **Qualifying Variant (QV)** : La base de données QV offre un cadre ouvert, partageable et reproductible pour l’interprétation génomique.\
...
* **Archipelago** : Paquet R pour la synthèse et l’interprétation des statistiques de tests d’association d’ensembles de variants (GitHub).\
...
* **PanelAppRex basic** : Configuration R et données pour la construction d’un modèle de base open-source (GitHub et Zenodo).\
...
* **Diagnostic génétique des inborn errors of immunity (IEI)** : Base de données open-source mondialement reconnue sur la génétique des IEI, fournie à la communauté comme sous-ensemble de PanelAppRex.\
